  ...
  return (
    <header className="h-14 border-b border-[#1a222d] bg-[#000000]/95 backdrop-blur-md flex items-center justify-between px-4 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="hidden md:flex items-center gap-1 text-zinc-400 mr-1">
          {siteConfig.X_URL && (
            <a href={siteConfig.X_URL} target="_blank" rel="noopener noreferrer" className="p-1.5 hover:text-zinc-100 transition-colors" title="Twitter / X">
              <XIcon />
            </a>
          )}
          {siteConfig.TELEGRAM_URL && (
            <a href={siteConfig.TELEGRAM_URL} target="_blank" rel="noopener noreferrer" className="p-1.5 hover:text-zinc-100 transition-colors" title="Telegram">
              <TelegramIcon />
            </a>
          )}
